...
window.tooltipTextEndLine = '</span></div></td>'
 ...
 var L6 = window.tooltipTextStart+" Timer       " , L6_1 = window.tooltipTextEnd+"► Add an in-game timer that counts down until a boss respawns<br>► Play a sound before a boss respawns"+window.tooltipTextEndLine
 var L8 = window.tooltipTextStart+" Whisper       " , L8_1 = window.tooltipTextEnd+"► Use <font color='#ffeb38'>/r</font> to quickly respond to whispers<br>► Play a sound when you receive a whisper"+window.tooltipTextEndLine
var L10 = window.tooltipTextStart+" Hide Quests     " , L10_1 = window.tooltipTextEnd+"Hide the Quests tab"+window.tooltipTextEndLine
var L11 = window.tooltipTextStart+" Map     " , L11_1 = window.tooltipTextEnd+"In-game map<br>► Change the Size<br><font color='#ffeb38'>+</font> , <font color='#ffeb38'>-</font><br>► Change the Position<br><font color='#ffeb38'>7</font> , <font color='#ffeb38'>8</font> , <font color='#ffeb38'>9</font> , <font color='#ffeb38'>0</font>"+window.tooltipTextEndLine
